...
\marginnote{This course is a particular flavor of Inquiry Based Learning known as a Modified Moore Method. Our principal ``modifications'' from R.L. Moore's method are (1) the use of a textbook as reference, and (2) allowing collaboration. (Also, I generally like my students, whoever they may be.)}
...
\marginnote{Go read the official syllabus carefully. There is more about grades in that document.}
