...
\marginnote[-25pt]{This is sometimes called the \emph{hypotenuse-leg} theorem. This is the Bohan-Mantz Theorem resolving Mantz's Conjecture HL. It is already done!}
\end{conjecture}
