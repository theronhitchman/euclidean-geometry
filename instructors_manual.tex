...
Then I give some contextual notes for each item in the script, section-by-section. These are much heavier at the beginning of the sequence, where things are probably less certain for a new instructor and more guidance would be helpful, and lighter at the end, where I hope other users of these notes will have picked up the feel of things.
...
include Tim McNichol reference and idea. the coppin mahavier et al book\\

talk about Hartshorne.

ed parker, gary richter and t kyle petersen. mike starbird and carol schumacher
...
When we have a completed argument, we thank the speakers with applause.
