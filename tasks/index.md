...
<div class="text-center">
  <a class="btn btn-lg btn-info btn-block" href="{{site.baseurl}}/class/" target="_blank">
    ...
    Spring 2017 Euclidean Geometry<br class="visible-xs" /> Class Conjectures and Questions</a>
</div>
...
<div class="col-xs-6 col-sm-4 col-lg-3 text-center">
  <a class="btn btn-default btn-lg btn-block" href="{{site.baseurl}}/tasks" target="_blank">
...
<div class="col-xs-6 col-sm-4 col-lg-3 text-center">
  <a class="btn btn-default btn-lg btn-block" href="{{site.baseurl}}/Trigonometry.pdf">
